...
import { createKeyStubFromId } from './ExecutableKeyStub';
...
export class ScriptStub implements Script {
  ...
  constructor(scriptKeyOrId: ExecutableKey | ExecutableId) {
    this.key = typeof scriptKeyOrId === 'object'
      ? scriptKeyOrId
      : createKeyStubFromId(scriptKeyOrId);
